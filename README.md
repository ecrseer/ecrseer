<div>
    <section style="float:center;">
        <h1><a href="https://ecrseer.github.io/">Gabriel Couto</a></h1>
        <h3>Aluno de <br/>Engenharia de Software no Infnet<br/> - Rio de Janeiro,Brasil</h3>
        <h6 > Procurando estágio </h6>
        <p style="float:left;">
            <a href="https://twitter.com/ecrseer" target="blank"><img style="float:center;" src="https://cdn.jsdelivr.net/npm/simple-icons@3.0.1/icons/twitter.svg" alt="ecrseer" height="30" width="40" /></a>
            <a href="https://linkedin.com/in/gabriel-justino-147246169" target="blank"><img style="float:center;" src="https://cdn.jsdelivr.net/npm/simple-icons@3.0.1/icons/linkedin.svg" alt="gabriel-justino-147246169" height="30" width="40" /></a>
        </p>
    </section>
